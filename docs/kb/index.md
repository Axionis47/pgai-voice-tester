...
- [[layer-grounding]] - holds what it knows, fabricates what it lacks (the real bug lives here)
...
- [[concept-epistemic-humility]] - the lens that ties the findings together: grounds what it knows, fabricates what it lacks, never says "I don't know"
- [[concept-demo-vs-real]] - the honesty filter that separates real bugs from demo artifacts

### Evidence

- [[calls]] - the index of all 14 calls, each linked to the finding it produced
