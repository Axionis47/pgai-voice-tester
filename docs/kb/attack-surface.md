...
| Grounding / hallucination | TESTED | Grounds facts it holds, fabricates policy it lacks and doubles down (the real bug). Seeded placeholders consistent across calls (demoted). | [[layer-grounding]], [[finding-overconfidence]], [[finding-demo-artifacts]] |
